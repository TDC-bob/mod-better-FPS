...
land_noise =
{
	noisemin = 0.0; -- the weight of a noise texture in a distance shot (вес текстуры шума на дальнем плане)
	noisemax = 0.4; -- the weight of a noise texture in a close shot (вес текстуры шума на ближнем плане)
	noise1front = 1000.0; --1000 -- the range of close shot for noise (дальность ближнего плана для шума)
	noise1back = 20000.0; --18000 -- the range of distance shot for noise (дальность дальнего плана для шума)
	noise1top = 2500.0;
	noise1bottom = 2000.0;
	noise1PerSquare = 5.0;
